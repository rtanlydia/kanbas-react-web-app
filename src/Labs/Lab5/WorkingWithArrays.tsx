...
export default function WorkingWithArrays() {
  ...
  return (
      <div id="wd-working-with-arrays">
        ...
        <div className="mb-2">
          <label htmlFor="wd-todo-id-completed" className="me-2">ID:</label>
          <input
        ...
        <div className="d-flex align-items-center mb-2">
          <label htmlFor="wd-todo-completed" className="me-2">Completed:</label>
          <input
        ...
        <div className="mb-2">
          <label htmlFor="wd-todo-description" className="me-2">Description:</label>
          <input
