  ...
  return (
      <div id="wd-lab1">
        ...
        <div id="wd-lists">
          ...
          My favorite recipe (from allrecipes):
        ...
        <div id="wd-images">
          ...
          <img id="wd-starship"
               width="400px"
               src="https://cdn.pixabay.com/photo/2015/09/12/00/46/buildings-936589_1280.jpg"
          />
          <br/>
          Loading a local image:
          <br/>
          <img id="wd-teslabot" src="images/Nunu's Birthday.jpg" height="200px"/>
        </div>
        <div id="wd-forms">
          <h4>Form Elements</h4>
          <form id="wd-text-fields">
            ...
            <input id="wd-text-fields-email" placeholder="123@gmail.com"/>
          </form>
        </div>
        <h5>Text boxes</h5>
        ...
        <input type="radio" name="radio-genre" id="wd-radio-comedy"/>
        <label htmlFor="wd-radio-comedy">Blue</label><br/>

        <input type="radio" name="radio-genre" id="wd-radio-drama"/>
        <label htmlFor="wd-radio-drama">Red</label><br/>

        <input type="radio" name="radio-genre" id="wd-radio-scifi"/>
        <label htmlFor="wd-radio-scifi">Pink</label><br/>

        <input type="radio" name="radio-genre" id="wd-radio-fantasy"/>
        <label htmlFor="wd-radio-fantasy">Black</label>
